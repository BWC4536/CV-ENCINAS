      ...
      <section className="bg-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-white font-black text-2xl uppercase tracking-wider">Próximo Partido</h2>
          </div>

          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-red-700 via-red-600 to-red-800 shadow-2xl">
            {/* Competition Tag */}
            <div className="absolute top-0 left-0 right-0 bg-black/30 px-6 py-3 flex items-center justify-between">
              <span className="text-yellow-400 text-xs font-black uppercase tracking-widest">Segunda Andaluza Masculina</span>
              <span className="text-white/60 text-xs font-medium">Liga Regular</span>
            </div>
            ...
            <div className="pt-14 pb-8 px-6 sm:px-10">
              <div className="grid grid-cols-3 items-center gap-4">
                ...
                <div className="flex flex-col items-center text-center gap-3">
                  ...
                  <div>
                    <div className="text-white font-black text-sm sm:text-base leading-tight">ENCINAS VOLLEY C.D.</div>
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="text-white/30 text-4xl sm:text-5xl font-black">VS</div>
                  <div className="bg-yellow-400 text-black text-xs font-black px-3 py-1 rounded-full uppercase tracking-wider">
                    En Juego
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center gap-3">
                  <div className="w-20 h-20 rounded-full bg-white/10 border-2 border-white/20 flex items-center justify-center">
                    <span className="text-white font-black text-2xl">MV</span>
                  </div>
                  <div>
                    <div className="text-white font-black text-sm sm:text-base leading-tight">MAIRENA VOLEY CLUB</div>
                    <div className="text-white/60 text-xs">Visitante</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="flex items-center gap-3 bg-black/20 rounded-xl px-4 py-3">
                  ...
                  <div>
                    <div className="text-white/60 text-xs">Fecha</div>
                    <div className="text-white font-bold text-sm">17 Enero 2026</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-black/20 rounded-xl px-4 py-3">
                  <Clock size={18} className="text-yellow-400 shrink-0" />
                  <div>
                    <div className="text-white/60 text-xs">Hora</div>
                    <div className="text-white font-bold text-sm">18:00 h</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-black/20 rounded-xl px-4 py-3">
                  <MapPin size={18} className="text-yellow-400 shrink-0" />
                  <div>
                    <div className="text-white/60 text-xs">Sede</div>
                    <div className="text-white font-bold text-sm">Pabellón Hernandez Albarracin</div>
                  </div>
                </div>
              </div>
            </div>
